...
{
	let "TASKNO += 1"
	echo "$TASKNO out of 20" > ${TASKPROGIDFILE}
}
...
function task1()
{
	...
	do
		...
		do
			...
			mkdir -p ${IMAGE_DIR}/region_for_task1/s${fixres}/${CURFB}
			...
			-s ${BINDIR}/task1/valueSettings.xml \
			-j \
			...
			-t ${IMAGE_DIR}/region_for_task1/s${fixres}/${CURFB}/pos0_ \
			-l 120 \
			-p ${TASKPROGIDFILE} \
			-r ${TUBERADIUS} \
			-i ${flip} \
		...
		do
			...
			-t ${IMAGE_DIR}/region_for_task1/s${fixres}/${CURFB}/pos1_ \
			-l 120 \
			-p ${TASKPROGIDFILE} \
			-r ${TUBERADIUS} \
			-i ${flip} \
...
function task2()
{
	...
	do
		...
		do
			...
			echo -e "\n##### with Normal case #####" >> $LOG
			echo "##### under seeding resolution of ${fixres}x${fixres}x${fixres} #####" >> $LOG
			mkdir -p ${IMAGE_DIR}/region_for_task2/s${fixres}/${CURFB}
			...
			-s ${BINDIR}/task2/valueSettings.xml \
			-i \
			...
			-t ${IMAGE_DIR}/region_for_task2/s${fixres}/${CURFB}/pos0_ \
			-l 120 \
			-k ${CURKEY} \
			-p ${TASKPROGIDFILE} \
			-r ${TUBERADIUS} \
		...
		do
			...
			-t ${IMAGE_DIR}/region_for_task2/s${fixres}/${CURFB}/pos1_ \
			-l 120 \
			-k ${CURKEY} \
			-p ${TASKPROGIDFILE} \
			-r ${TUBERADIUS} \
...
function task5()
{
	...
	do
		...
		do
			...
			-s ${BINDIR}/task5/valueSettings.xml \
			-i \
