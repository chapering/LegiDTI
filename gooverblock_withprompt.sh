...
function task1()
{
	...
	do
		...
		do
			...
			mkdir -p ${IMAGE_DIR}/region_for_task1/s${n}/${CURFB}
			...
			-t ${IMAGE_DIR}/region_for_task1/s${n}/${CURFB}/block${RESID}_ \
			-l 120 \
			-r ${TUBERADIUS} \
			-i ${flip} 
...
function task2()
{
	...
	do
		...
		do
			echo "seeding resolution of ${n}x${n}x${n}, bundle of $CURFB" 
			mkdir -p ${IMAGE_DIR}/region_for_task2/s${n}/${CURFB}
			...
			-t ${IMAGE_DIR}/region_for_task2/s${n}/${CURFB}/${RESID}_ \
			-l 120 \
			-r ${TUBERADIUS} \
			-k ${CURKEY}
			#-k ${keys[$((n-1))]} 
