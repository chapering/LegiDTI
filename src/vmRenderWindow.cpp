	...
	m_nFlip(0)
{
	...
	setupUi( this );
	//renderView->setGeometry( QRect(0,0,1920,1000) );
...
int CLegiMainWindow::mainstay()
{
	...
	__add_axes();
	__loadBoxpos();
	CaptureImages(m_strfntask.c_str(), m_lod);

	exit(0);

	m_cout << "capturing finished \n";
...
void CLegiMainWindow::CaptureImages(const char* prefix, int range)
{
	/*
